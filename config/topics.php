...
return [
    'laravel'    => ['label' => 'Laravel',    'color' => '#f97316', 'batch' => 1],
    'nextjs'     => ['label' => 'Next.js',    'color' => '#111827', 'batch' => 1],
    ...
    'typescript' => ['label' => 'TypeScript', 'color' => '#3178c6', 'batch' => 2],
    'javascript' => ['label' => 'JavaScript', 'color' => '#a16207', 'batch' => 2],
    'php'        => ['label' => 'PHP',        'color' => '#6366f1', 'batch' => 2],
    'database'   => ['label' => 'Database',   'color' => '#10b981', 'batch' => 2],
];
